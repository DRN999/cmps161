...
class cell_grid
{
	...
	public: 
		...
		vector<double>* get_cell_value(int x, int y); // returns the value inside the cell for 2d
		vector<double>* get_cell_value(int x, int y, int z); // returns the value inside the cell for 3d
		...
		void set_cell(int x, int y, vector<double>* val); // .. 
		void set_cell(int x, int y, int z, int num, ...); // sets cell value of index for 3d 
		void set_cell(int x, int y, int z, vector<double>* val); // .. 
};
